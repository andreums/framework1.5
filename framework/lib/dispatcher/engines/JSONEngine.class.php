 ...
 *
 */
class jsonEngine implements  IEngine {
	/**
     * The module
     *
     * @var string
     ...
     * @return void
     */
    public function __construct($module,$controller,$action,$authentication=false) {
        $this->_module = $module;
